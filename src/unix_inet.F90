...
module unix_inet
    ...
    interface
        ...
        function c_htonl(host) bind(c, name='htonl')
            import :: c_uint32_t
            implicit none
            integer(c_uint32_t), intent(in), value :: host
            integer(c_uint32_t)                    :: c_htonl
        ...
        function c_htons(host) bind(c, name='htons')
            import :: c_uint16_t
            implicit none
            integer(c_uint16_t), intent(in), value :: host
            integer(c_uint16_t)                    :: c_htons
        ...
        function c_inet_addr(cp) bind(c, name='inet_addr')
            ...
            implicit none
            character(c_char), intent(in) :: cp
            integer(c_in_addr_t)          :: c_inet_addr
