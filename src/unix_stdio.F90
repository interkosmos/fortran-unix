...
module unix_stdio
    ...
    interface
        ...
        function c_putchar(char) bind(c, name='putchar')
            import :: c_int
            implicit none
            integer(c_int), intent(in), value :: char
