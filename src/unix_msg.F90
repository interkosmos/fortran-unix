...
module unix_msg
    ...
    interface
        ...
        function c_msgget(key, msgflg) bind(c, name='msgget')
            ...
            integer(c_int),   intent(in), value :: msgflg
            integer(c_int)                      :: c_msgget
        ...
        function c_msgrcv(msqid, msgp, msgsz, msgtyp, msgflg) bind(c, name='msgrcv')
            ...
            integer(c_size_t), intent(in), value :: msgsz
            integer(c_long)  , intent(in), value :: msgtyp
            integer(c_int),    intent(in), value :: msgflg
            integer(c_size_t)                    :: c_msgrcv
